...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const buttons = document.querySelectorAll(".video-swapper")
    let currentPosition = 0

    buttons.forEach(button => {
        button.addEventListener('click', () => {
            const translateValue = parseInt(button.getAttribute("data-translate"), 10)

            currentPosition += translateValue
            ...
            watcher.style.transform = `translateX(${currentPosition}%)`
